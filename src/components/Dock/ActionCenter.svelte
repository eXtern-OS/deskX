<script lang="ts">
  ...
  function toggleTheme() {
    if (wallpapersConfig[$wallpaper.id].type === 'adaptive' && $wallpaper.canControlTheme) {
  ...
  >
    <ActionCenterTile grid={[1, 1]}>
      <div style="width: 100%; height: 100%">
        <div class="itai-results"></div>
        <input placeholder="Ask ITAI"/> <button><img
          width="18"
          height="18"
          src="/dock/send.svg"
          alt="Ask ITAI"
